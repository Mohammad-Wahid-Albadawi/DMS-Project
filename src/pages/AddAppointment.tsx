...
const AddAppointment = () => {
  ...
  function handleChangeAppointmentDate(
  ...
  return (
    <form onSubmit={handleSubmit(submitData)} className="form-appointment">
      <Stack gap="4" align="flex-start" width={"100%"}>
        <Text
          mr={{ base: "2rem", sm: "6rem" }}
          fontWeight={"bold"}
          color={"teal.600"}
          fontSize={{ sm: "1.25rem" }}
        >
          إدخال معلومات المريض والحجز
        </Text>
        {/* patient's name */}
        ...
        <Field.Root invalid={!!formState.errors.appointmentType}>
          ...
          <Field.ErrorText>
            {formState.errors.appointmentType?.message}
          </Field.ErrorText>
        </Field.Root>
        {/* reservation history */}
